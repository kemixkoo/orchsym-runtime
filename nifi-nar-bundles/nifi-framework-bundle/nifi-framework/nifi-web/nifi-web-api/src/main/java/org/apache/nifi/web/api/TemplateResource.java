...
public class TemplateResource extends ApplicationResource {
    ...
    public Response exportTemplate(
        ...
        /*
         * Here instead of relying on default JAXB marshalling we are simply serializing template to String (formatted, indented etc) and sending it as part of the response.
         */
