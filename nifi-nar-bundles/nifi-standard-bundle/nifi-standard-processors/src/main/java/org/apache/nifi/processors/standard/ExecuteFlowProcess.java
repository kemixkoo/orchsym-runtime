...
@Marks(categories = { "Execute/Execute" }, createdDate = "2019-12-25", note = "")
...
public class ExecuteFlowProcess extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        final String command = context.getProperty(COMMAND).evaluateAttributeExpressions(original).getValue();
        final String arguments = context.getProperty(COMMAND_ARGUMENTS).isSet()
          ? context.getProperty(COMMAND_ARGUMENTS).evaluateAttributeExpressions(original).getValue()
          : null;
