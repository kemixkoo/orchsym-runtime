...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__ControllerServices__model.js' */'E:/bitbucket/nifi/orchsym/orchsym-fe/src/pages/ControllerServices/model.js').then(m => { return { namespace: 'model',...m.default}})
],
