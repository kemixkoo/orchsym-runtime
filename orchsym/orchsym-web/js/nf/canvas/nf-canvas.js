...
(function (root, factory) {
    ...
    var config = {
        urls: {
            ...
            controllerBulletins: apiHost + "/nifi-api/flow/controller/bulletins",
            kerberos: apiHost + "/nifi-api/access/kerberos",
            oidc: apiHost + "/nifi-api/access/oidc/exchange",
            revision: apiHost + "/nifi-api/flow/revision",
