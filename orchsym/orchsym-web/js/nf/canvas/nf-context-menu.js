...
(function (root, factory) {
    ...
    var menuItems = [
        ...
        {id: 'to-front-menu-item', condition: canMoveToFront, menuItem: {clazz: 'fa fa-clone', text: nf._.msg('nf-context-menu.BringFront'), action: 'toFront'}},
        {id: 'center-menu-item', condition: isNotConnection, menuItem: {clazz: 'fa fa-crosshairs', text: nf._.msg('nf-context-menu.CenterInView'), action: 'center'}},
        {id: 'fill-color-menu-item', condition: isColorable, menuItem: {clazz: 'fa fa-paint-brush', text: nf._.msg('nf-context-menu.ChangeColor'), action: 'fillColor'}},
        {id: 'open-uri-menu-item', condition: isRemoteProcessGroup, menuItem: {clazz: 'fa fa-external-link', text: nf._.msg('nf-context-menu.GoTo'), action: 'openUri'}},
        {separator: true},
        {id: 'move-into-parent-menu-item', condition: canMoveToParent, menuItem: {clazz: 'fa fa-arrows', text: nf._.msg('nf-context-menu.MoveParentGroup'), action: 'moveIntoParent'}},
        ...
        {separator: true},
        {id: 'empty-queue-menu-item', condition: canEmptyQueue, menuItem: {clazz: 'fa fa-minus-circle', text: nf._.msg('nf-context-menu.EmptyQueue'), action: 'emptyQueue'}},
        {id: 'delete-menu-item', condition: isDeletable, menuItem: {clazz: 'fa fa-trash', text: nf._.msg('nf-context-menu.Delete'), action: 'delete'}}
    ];
