...
(function (root, factory) {
    ...
    var performListing = function (connection) {
        ...
        return $.Deferred(function (deferred) {
            ...
            $.ajax({
                type: 'POST',
                url: apiHost + "/nifi-api/flowfile-queues/" + connection.id + '/listing-requests',
                dataType: 'json',
        ...
        $.ajax({
            ...
            if (nfCommon.isDefinedAndNotNull(flowFile.contentClaimContainer)) {
                ...
                if (nfCommon.isDefinedAndNotNull(flowFile.contentClaimFileSize)) {
                    ...
                    contentSize.attr('title', nfCommon.formatInteger(flowFile.contentClaimFileSizeBytes) + nf._.msg('nf-queue-listing.Bytes'));
                }
    ...
    var nfQueueListing = {
        init: function () {
            ...
            var queueListingColumns = [
                ...
                {
                    id: 'filename',
                    name: nf._.msg('nf-queue-listing.FileName'),
                    field: 'filename',
                    sortable: false,
                    resizable: true,
                    formatter: nfCommon.genericValueFormatter
